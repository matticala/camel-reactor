...
public class ReactorToJmsToFileRouteTest extends ReactorBaseTestSupport {
    ...
    return new RouteBuilder() {
      ...
      public void configure() throws Exception {
        ...
        this.from("activemq:queue:X.Y.Z")
            .log(LoggingLevel.DEBUG, logger, String.format(LOG_STRING, ++step)).to("seda:SEDANINI");
  ...
  protected CamelContext createCamelContext() throws Exception {
    ...
    connectionFactory
        .setBrokerURL("vm:(broker:(tcp://localhost:61616)?persistent=false&useJmx=true)?marshal=false");
